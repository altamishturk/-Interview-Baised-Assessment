...
import {logoutUser} from "../store/ActionCreators/auth.ts";
import {CgProfile} from "react-icons/cg";
import {AiOutlineShoppingCart} from "react-icons/ai";
import orderList from "../assets/order-list-64.png";
                ...
                <div className="relative">
                    ...
                    <div id="md-searchbar" className={`${mdOptionsToggle ? "hidden" : "flex"} bg-white dark:bg-gray-900 lg:hidden py-5 px-6 items-center justify-between`}>
                        ...
                        <div className="space-x-6 flex">
                            ...
                            <CgProfile title="View Profile" size={24} onClick={handleProfileClick}/>
                        </div>
                    </div>
                    {/* For md screen size */}
                    {/* For large screens */}
                                ...
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    {
                                        ...
                                        <Link to="/my-orders">
                                            <img className="h-7" src={orderList} title="My Orders" alt="order" />
                                        </Link>
                                        ...
                                        <CgProfile title="View Profile" size={28} onClick={handleProfileClick}/>
                                        </>
                                    }
